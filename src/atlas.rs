...
use crate::constants::{COMMANDER_SIZE, TANK_DISPLAY_SIZE};
...
pub const BACKGROUND_ATLAS: TextureAtlasInfo = {
    let mut atlas = TextureAtlasInfo::new("texture/background.png", Vec2::new(960.0, 960.0), 5, 5);
...
pub const SMOKE_ATLAS: TextureAtlasInfo = {
    let mut atlas = TextureAtlasInfo::new("effect/smoke_sprite.png", Vec2::new(100.0, 100.0), 5, 3);
...
pub const EXPLOSION_ATLAS: TextureAtlasInfo = {
    let mut atlas = TextureAtlasInfo::new("effect/explosion.png", Vec2::new(256.0, 256.0), 8, 8);
...
pub const SPARK_ATLAS: TextureAtlasInfo = {
    let mut atlas = TextureAtlasInfo::new("effect/hit_spark.png", Vec2::new(256.0, 256.0), 4, 4);
...
pub const ENEMY_BORN_ATLAS: TextureAtlasInfo = {
    let mut atlas = TextureAtlasInfo::new("effect/enemy_born.png", Vec2::new(340.0, 340.0), 5, 3);
    atlas.display_size = Vec2::new(100.0, 100.0);
...
// 玩家坦克精灵图常量
pub const PLAYER_TANK1_ATLAS: TextureAtlasInfo =
    TextureAtlasInfo::new("texture/player_tank1.png", Vec2::new(293.0, 328.0), 2, 1)
        .with_display_size(TANK_DISPLAY_SIZE);

// 玩家坦克2精灵图常量
pub const PLAYER_TANK2_ATLAS: TextureAtlasInfo =
    TextureAtlasInfo::new("texture/player_tank2.png", Vec2::new(293.0, 328.0), 2, 1)
        .with_display_size(TANK_DISPLAY_SIZE);

// 指挥官精灵图常量
// 实际尺寸: 1400 x 1200, 10行10列, 每帧 140 x 120
pub const COMMANDER_ATLAS: TextureAtlasInfo =
    TextureAtlasInfo::new("texture/commander.png", Vec2::new(140.0, 120.0), 10, 10)
...
pub const PLAYER_AVATAR_ATLAS: TextureAtlasInfo = {
    let mut atlas = TextureAtlasInfo::new("texture/avatar.png", Vec2::new(160.0, 147.0), 13, 3);
...
pub const SEA_ATLAS: TextureAtlasInfo =
    TextureAtlasInfo::new("maps/sea_sheet.png", Vec2::new(100.0, 100.0), 3, 1);

// 森林精灵图常量
// 实际尺寸: 1310 x 131, 1行10列, 每帧 131 x 131
pub const FOREST_ATLAS: TextureAtlasInfo =
    TextureAtlasInfo::new("maps/tree.png", Vec2::new(131.0, 131.0), 10, 1);
...
pub const ENERGY_BALL_RED_ATLAS: TextureAtlasInfo = {
    let mut atlas =
        TextureAtlasInfo::new("effect/energy_red_ball.png", Vec2::new(675.0, 488.0), 17, 5);
    atlas.display_size = Vec2::new(405.0, 293.0);
    atlas
};
...
pub const POWER_UP_SPEED_UP_ATLAS: TextureAtlasInfo =
    TextureAtlasInfo::new("power_up/speed_up.png", Vec2::new(87.0, 69.0), 3, 1);

pub const POWER_UP_PROTECTION_ATLAS: TextureAtlasInfo =
    TextureAtlasInfo::new("power_up/protection.png", Vec2::new(87.0, 69.0), 3, 1);

pub const POWER_UP_FIRE_SPEED_ATLAS: TextureAtlasInfo =
    TextureAtlasInfo::new("power_up/fire_speed.png", Vec2::new(87.0, 69.0), 3, 1);

pub const POWER_UP_FIRE_SHELL_ATLAS: TextureAtlasInfo =
    TextureAtlasInfo::new("power_up/fire_shell.png", Vec2::new(87.0, 69.0), 3, 1);

pub const POWER_UP_TRACK_CHAIN_ATLAS: TextureAtlasInfo =
    TextureAtlasInfo::new("power_up/track_chain.png", Vec2::new(87.0, 69.0), 3, 1);

pub const POWER_UP_PENETRATE_ATLAS: TextureAtlasInfo =
    TextureAtlasInfo::new("power_up/penetrate.png", Vec2::new(87.0, 69.0), 3, 1);

pub const POWER_UP_REPAIR_ATLAS: TextureAtlasInfo =
    TextureAtlasInfo::new("power_up/repair.png", Vec2::new(87.0, 69.0), 3, 1);

pub const POWER_UP_HAMBURGER_ATLAS: TextureAtlasInfo =
    TextureAtlasInfo::new("power_up/hamburger.png", Vec2::new(87.0, 69.0), 3, 1);

pub const POWER_UP_AIR_CUSHION_ATLAS: TextureAtlasInfo =
    TextureAtlasInfo::new("power_up/air_cushion.png", Vec2::new(87.0, 69.0), 3, 1);
